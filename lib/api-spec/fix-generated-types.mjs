...
// Also remove the conflicting loginResponse / loginResponseRole type files
// from the types index, since they clash with identically-named Zod schemas.
...
if (existsSync(TYPES_INDEX)) {
  ...
  const conflicts = ["loginResponse", "loginResponseRole"];
