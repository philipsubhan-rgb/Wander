...
router.patch("/trips/:tripId/itinerary/:dayId", requireAdmin, async (req, res): Promise<void> => {
...
router.delete("/trips/:tripId/itinerary/:dayId", requireAdmin, async (req, res): Promise<void> => {
