                ...
                <div className="mt-5 grid gap-4 md:grid-cols-2">
                  {flights.map((flight) => (
                    <div className="rounded-xl border border-border/70 p-4" key={flight.id} data-testid={`card-guide-flight-${flight.id}`}>
                      ...
                      <p className="mt-3 text-xs leading-5 text-muted-foreground">{formatGuideDate(flight.departureDatetime, 'EEE, MMM d · h:mm a')} — {formatGuideDate(flight.arrivalDatetime, 'h:mm a')}</p>
